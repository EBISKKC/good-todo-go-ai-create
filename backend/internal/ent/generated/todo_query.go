...
func (_q *TodoQuery) QueryTenant() *TenantQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.M2O, true, todo.TenantTable, todo.TenantColumn),
		)
...
func (_q *TodoQuery) WithTenant(opts ...func(*TenantQuery)) *TodoQuery {
	query := (&TenantClient{config: _q.config}).Query()
...
func (_q *TodoQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Todo, error) {
	...
	if query := _q.withTenant; query != nil {
		if err := _q.loadTenant(ctx, query, nodes, nil,
			func(n *Todo, e *Tenant) { n.Edges.Tenant = e }); err != nil {
			return nil, err
		}
	}
...
func (_q *TodoQuery) loadTenant(ctx context.Context, query *TenantQuery, nodes []*Todo, init func(*Todo), assign func(*Todo, *Tenant)) error {
...
func (_q *TodoQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withTenant != nil {
			_spec.Node.AddColumnOnce(todo.FieldTenantID)
		}
		if _q.withUser != nil {
