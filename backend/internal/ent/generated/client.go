...
import (
	...
	"good-todo-go/internal/ent/generated/migrate"
...
// QueryTodos queries the todos edge of a Tenant.
func (c *TenantClient) QueryTodos(_m *Tenant) *TodoQuery {
...
func (c *TodoClient) QueryTenant(_m *Todo) *TenantQuery {
